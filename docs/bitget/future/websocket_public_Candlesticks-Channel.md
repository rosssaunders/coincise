...
The channel will push a snapshot after successful subscribed, later on the
updates will be pushed

If intended to query history data in a customized time range, please refer to
[Get Candle Data](/api-doc/contract/market/Get-Candle-Data)
