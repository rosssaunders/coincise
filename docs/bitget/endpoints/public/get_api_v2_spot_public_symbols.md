...
| buyLimitPriceRatio | String | Percentage spread between bid and ask, in decimal form  
E.g. 0.05 means 5% |
| sellLimitPriceRatio | String | Percentage spread between sell and current price, in decimal form  
E.g. 0.05 means 5% |
| orderQuantity | String | The maximum number of orders allowed for the current symbol |
| areaSymbol | String | Area symbol  
`yes`, `no` |
