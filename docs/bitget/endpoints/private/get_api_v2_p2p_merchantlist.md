...
| :-------- | :----- | :------- | :-------------- |
| online    | String | No       | Whether online? |

yes: online  
no: offline | | idLessThan | String | No | The minMerchantId returned from the
previous query.  
Returns data whose ID is less than the entry parameter. | | limit | String | No
| Number of queries  
...
| \> avgPaymentTime      | String | Average payment time                          |
| (in minutes)           |
| \> avgReleaseTime      | String | Average time to release coins                 |
| (in minutes)           |
