...
The result for the estimated openable quantity does not include current
positions and existing orders.
...
openAmount | String | Yes | Margin amount | | openPrice | String | Yes | Price
of the order | | leverage | String | No | Leverage  
default 20 |
