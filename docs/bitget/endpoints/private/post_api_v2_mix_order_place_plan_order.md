...
| stopSurplusTriggerPrice | String | No | Take-profit trigger price/Take-profit ratio  
...
| stopLossTriggerPrice | String | No | Stop-loss trigger price/Stop-loss ratio  
