...
profit\_loss: take profit and stop loss orders(including the profit\_plan, loss\_plan, moving\_plan, pos\_profit and pos\_loss) |
| symbol | String | No | Trading pair, e.g. ETHUSDT |
...
| \>price | String | Order execute price  
...
| \>callbackRatio | String | Implementation of the callback rate. (Range 1-10)  
...
index\_price: index price |
| \>planStatus | String | Order status  
For a current trigger order, the status will only be `live` |
