...
String | No | Number of results returned: Default: 100, max 100 | | idLessThan |
String | No | Requests the content on the page before this ID (older data), the
value input should be the tradeId of the corresponding interface. |
...
taker Taker  
maker Maker | | feeDetail | Object | Transaction fee breakdown | | \>deduction |
String | Discount or not | | \>feeCoin | String | Transaction fee coin | |
\>totalDeductionFee | String | Total transaction fee discount | | \>totalFee |
String | Total transaction fee |

> **Source:** https://www.bitget.com/api-doc/spot/trade/Get-Fills
