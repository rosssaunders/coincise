...
| --- | --- | --- |
| /spot/v1/submit\_order | New Order(v1) | /spot/v2/submit\_order |
| /spot/v1/batch\_orders  
/spot/v2/batch\_orders | New Batch Order(v1)  
New Batch Order(v2) | /spot/v4/batch\_orders |
| /spot/v1/cancel\_order  
/spot/v2/cancel\_order | Cancel Order(v1)  
Cancel Order(v2) | /spot/v3/cancel\_order |
| /spot/v1/cancel\_orders | Cancel Batch Order(v1) | /spot/v4/cancel\_orders  
/spot/v4/cancel\_all |
| /spot/v2/order\_detail | Query Order(v2) | /spot/v4/query/order |
...
| /spot/v1/ticker\_detail | Get Ticker of a Trading Pair (V1) | /spot/quotation/v3/ticker |
