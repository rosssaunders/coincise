# GET Get Latest K-Line (V3)

**Source:** [Get Latest K-Line (V3)](https://developer-pro.bitmart.com/en/spot/)
...
| v | String | Trading volume, with a unit of currency (If in BTC\_USDT, The unit is BTC) |
| qv | String | Trading volume, the value is the quantity in quote currency (If in BTC\_USDT, The unit is USDT) |