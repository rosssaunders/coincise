...
**Source:** [Submit Trail Order (SIGNED)](https://developer-pro.bitmart.com/en/futuresv2/)
...
| activation\_price\_type | Int | Yes | Activation price type, required at trailing order  
\-`1`\=last\_price  
\-`2`\=fair\_price |
