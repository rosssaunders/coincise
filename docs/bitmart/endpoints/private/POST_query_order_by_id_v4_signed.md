# POST Query Order By Id (v4) (SIGNED)

**Source:**
[Query Order By Id (v4) (SIGNED)](https://developer-pro.bitmart.com/en/spot/)
...
recvWindow | Long | No | Trade time limit, allowed range (0,60000\], default:
5000 milliseconds |
