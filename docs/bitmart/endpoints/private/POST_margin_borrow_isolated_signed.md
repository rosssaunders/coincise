...
**Source:** [Margin Borrow (Isolated)  (SIGNED)](https://developer-pro.bitmart.com/en/spot/)
...
| --- | --- | --- |
| borrow\_id | String | Borrowing order ID, only successful borrowing will be returned |