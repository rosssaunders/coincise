...
| /spot/v1/user\_fee | Basic Fee Rate | X-BM-KEY | 2 times/2 sec |
| /spot/v1/trade\_fee | Actual Trade Fee Rate | X-BM-KEY | 2 times/2 sec |
...
| /spot/v2/submit\_order | New Order(v2) (SIGNED) | UID | 40 times/2 sec |
| /spot/v4/batch\_orders | New Batch Order(v4) (SIGNED) | UID | 40 times/2 sec |
| /spot/v1/margin/submit\_order | New Margin Order (SIGNED) | UID | 20 times/1 sec |
| /spot/v3/cancel\_order | Cancel Order(v3) (SIGNED) | UID | 40 times/2 sec |
| /spot/v4/cancel\_orders | Cancel Batch Order(v4) (SIGNED) | UID | 40 times/2 sec |
| /spot/v4/cancel\_all | Cancel All Order(v4) (SIGNED) | UID | 1 times/3 sec |
...
| /spot/v1/margin/isolated/borrow\_record | Get Borrow Record(Isolated) | X-BM-KEY | 150 times/2 sec |
| /spot/v1/margin/isolated/repay\_record | Get Repayment Record(Isolated) | X-BM-KEY | 150 times/2 sec |
