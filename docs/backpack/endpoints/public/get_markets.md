...
| ---------- | -------- | ------- | ---------------------------------------------- |
| marketType | optional | strings | Market type. Defaults to return spot and perp. |
...
| positionLimitWeight   | optional | string <decimal>         | Position limit weight coefficient. Used to calculate position limits when clearing a trade. |
