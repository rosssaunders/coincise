...
*   Each connection to **ws://wbs-api.mexc.com/ws** is valid for no more than 24 hours. Please handle disconnections and reconnections properly.
...
{ "method": "UNSUBSCRIPTION", "params": \["spot@public.deals.v3.api.pb@BTCUSDT"\] }
