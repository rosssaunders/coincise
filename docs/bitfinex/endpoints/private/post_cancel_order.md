...
The ID of the order to cancel (can be get using the [Retrieve Orders](/reference#rest-auth-retrieve-orders) and the [Retrieve Orders (by symbol)](/reference#rest-auth-retrieve-orders-by-symbol) endpoints).
