...
deposit adddress data | | [5] | CODE | int | W.I.P. (work in progress) | | [6] |
...
| [1] | METHOD | String | Method of deposit | | [2] | CURRENCY_CODE | String |
Currency code of new address |

[ . . . ]

| [4] | ADDRESS | String | Deposit address (instead of the address, this field
will show Tag/Memo/Payment_ID for currencies that require it) | | [5] |
