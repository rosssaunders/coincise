...
| [4] | DATA | [Claim Array](#claim-array)[] | An array containing info on the
position claim | | [5] | CODE | int | W.I.P. (work in progress) | | [6] | STATUS
...
| [11] | POSITION_ID | int | position identifier | | [12] | MTS_CREATE | time |
Timestamp of creation (millis) | | [13] | MTS_UPDATE | time | Timestamp of last
update (millis) |
