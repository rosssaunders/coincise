...
| [9] | FLAGS | Object | Future params object (stay tuned) | | [10] | STATUS |
String | Offer Status: ACTIVE, PARTIALLY FILLED |

[ . . . ]

| [14] | RATE | Float | Rate of the offer (percentage expressed as decimal
number i.e. 1% = 0.01) | | [15] | PERIOD | Int | Period of the offer | | [16] |
NOTIFY | Int | 0 if false, 1 if true | | [17] | HIDDEN | Int | null if false, 1
if true |
