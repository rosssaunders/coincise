...
if false, 1 if true | | [21] | POSITION_PAIR | String | Pair of the position
that the funding was used for |
...
curl \--request POST \\
     ...
     \--url https://api.bitfinex.com/v2/auth/r/funding/credits/Symbol \\
