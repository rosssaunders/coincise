...
| | \[11\] | POSITION_ID | int | Position ID | | \[12\] | MTS_CREATE | int |
Millisecond timestamp of creation | | \[13\] | MTS_UPDATE | int | Millisecond
timestamp of update | |

\[ . . . \]

| | \[15\] | TYPE | int | Identifies the type of position: 0 = Margin position,
1 = Derivatives position | |

\[ . . . \]

| | \[17\] | COLLATERAL | float | Position collateral | | \[18\] |
COLLATERAL_MIN | float | Min Collateral Required | | \[19\] | META | JSON str |
Meta data about the position |
...
https://docs.bitfinex.com/reference/rest-auth-positions Path:
/v2/auth/r/positions Method: POST
