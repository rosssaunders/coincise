...
>
> For funding use format "f[Symbol]" (e.g. fUSD, fBTC, fETH, ...). A list of all
> possible symbols can be retrieved from [Configs](/reference/rest-public-conf)
> by calling
...
| [16] | FRR_AMOUNT_AVAILABLE | float | The amount of funding that is available
