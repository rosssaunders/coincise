...
| [3] | FRR | float | 1/365th of Flash Return Rate (To get the daily rate, use:
**rate x 365**. To get the daily rate as percentage use: **rate x 365 x 100**.
To get APR as percentage use **rate x 100 x 365 x 365**.) | | [4] | AVG_PERIOD |
float | Average period for funding provided |
