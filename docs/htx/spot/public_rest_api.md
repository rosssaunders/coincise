...
Interface description: This endpoint retrieves the current order book of a
specific pair.
...
When the type value is 'step0', if 'depth' is not entered, the default value is
150。
...
Interface description: This endpoint retrieves the latest trade with its price,
