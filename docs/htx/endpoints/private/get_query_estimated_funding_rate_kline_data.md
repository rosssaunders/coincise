...
**Source:**
[Query Estimated Funding Rate Kline Data](https://www.htx.com/en-us/opend/newApiPages/?id=5d5181c7-77b6-11ed-9966-0242ac110003)
...
### /index/market/history/swap_estimated_rate_kline (Query Estimated Funding Rate Kline Data)
...
| ------------- | --------- | -------- | ------------- | ------------------------------------------------------------------------------------ | ------------- |
| contract_code | string    | true     | contract code | Case-Insenstive.Both uppercase and lowercase are supported.e.g. "BTC-USD","ETH-USD". |               |
...
"market.BTC-USD.estimated_rate.5min"
