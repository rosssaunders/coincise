...
**Source:**
[Check whether the user is eligible for rebate](https://www.htx.com/en-us/opend/newApiPages/?id=8cb89359-77b5-11ed-9966-18c8f982264)
...
### /broker/v1/user_rebate_status (Check whether the user is eligible for rebate)
...
Interface description: This endpoint is used for API brokers to check whether
users meet the conditions for rebates on the HTX The endpoint is not open to the
public but only available to particular API brokers.
