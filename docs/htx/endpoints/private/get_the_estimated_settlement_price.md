...
**Source:** [Get the estimated settlement price](https://www.htx.com/en-us/opend/newApiPages/?id=5d5169d1-77b6-11ed-9966-0242ac110003)
...
### /swap-api/v1/swap\_estimated\_settlement\_price (Get the estimated settlement price)
...
| --- | --- | --- | --- | --- | --- |
| contract\_code | string | false | contract code, return all without filling in | "BTC-USD" ... |  |
