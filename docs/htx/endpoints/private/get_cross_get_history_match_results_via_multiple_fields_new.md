# GET [Cross]Get History Match Results via Multiple Fields(New)

**Source:**
[[Cross]Get History Match Results via Multiple Fields(New)](https://www.htx.com/en-us/opend/newApiPages/?id=8cb86785-77b5-11ed-9966-0242ac110003)
...
### /linear-swap-api/v3/swap_cross_matchresults_exact (\[Cross\]Get History Match Results via Multiple Fields(New))
...
format is BTC-USDT-210625. When both of pair and contract filled in, the
contract_code is the preferred.
...
| match_id          | long         | true     | matching result id, not unique, may be repeated                                                                                                                       |                                                                                       |
