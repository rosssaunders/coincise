...
**Source:**
[Query withdraw address](https://www.htx.com/en-us/opend/newApiPages/?id=7ec50654-7773-11ed-9966-0242ac110003)
...
Interface description: This endpoint allows parent user to query withdraw
address available for API key.
...
Notes: The chain names of the universal addresses include:
erc20、trc20、avaxcchain、SOLANA、BRC20、ARBITRUM、OPTIMISM、BTT、bep20、adachain、heco
