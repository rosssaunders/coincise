# GET [Cross] Get History Orders(New)

**Source:**
[[Cross] Get History Orders(New)](https://www.htx.com/en-us/opend/newApiPages/?id=8cb85ba1-77b5-11ed-9966-0242ac110003)
...
### /linear-swap-api/v3/swap_cross_hisorders (\[Cross\] Get History Orders(New))
...
format is BTC-USDT-210625. one of pair and contract must be filled in(if both of
