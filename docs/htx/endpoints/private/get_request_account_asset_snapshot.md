...
**Source:**
[Request account asset snapshot](https://www.htx.com/en-us/opend/newApiPages/?id=8cb89359-77b5-11ed-9966-18c8feecce2)
...
### /broker/v1/account_capital_snapshot_everyday (Request account asset snapshot)
...
Interface description: Users can request the account asset snapshot via this
endpoint;
...
| ------------ | --------- | -------- | -------------------------------------------------------------------------------------------------------------------- | ----------- | ------------- |
| start_time   | Long      | false    | Starting time If startTime and endTime are not transmitted, the data of the last 7 days will be returned by default. |             |               |
| end_time     | Long      | false    | End Time The start and end times cannot differ by more than 30 days.                                                 |             |               |
| account_type | String    | true     | account type: spot margin-api super-margin-api delivery swap linear                                                  |             |               |
