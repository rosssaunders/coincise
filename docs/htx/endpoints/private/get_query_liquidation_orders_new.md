...
**Source:**
[Query Liquidation Orders(New)](https://www.htx.com/en-us/opend/newApiPages/?id=5d516e00-77b6-11ed-9966-0242ac110003)
...
### /swap-api/v3/swap_liquidation_orders (Query Liquidation Orders(New))
...
| ---------- | --------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| start_time | long      | false    |                                                                                                                                                                                          | Value range \[((end-time) – 2h), (end-time)\], maximum query window size is 2 hours, query window shift should be within past 90 days, query window shift should be within past 2 hours for cancelled order | (now) – 2h    |
