# GET [Isolated] Place an Order

**Source:**
[[Isolated] Place an Order](https://www.htx.com/en-us/opend/newApiPages/?id=8cb844bb-77b5-11ed-9966-0242ac110003)
...
### /linear-swap-api/v1/swap_order (\[Isolated\] Place an Order)
...
the upper limit is 5,000,000 for open/close orders.  
