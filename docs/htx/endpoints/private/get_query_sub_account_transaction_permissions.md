...
**Source:**
[Query sub-account transaction permissions](https://www.htx.com/en-us/opend/newApiPages/?id=8cb89359-77b5-11ed-9966-18d1210ad9a)
...
### /swap-api/v1/swap_sub_auth_list (Query sub-account transaction permissions)
