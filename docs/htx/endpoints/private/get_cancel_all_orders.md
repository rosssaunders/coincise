...
**Source:**
[Cancel All Orders](https://www.htx.com/en-us/opend/newApiPages/?id=5d51a25e-77b6-11ed-9966-0242ac110003)
...
### /swap-api/v1/swap_cancelall (Cancel All Orders)
...
Notes:  
result of multiple order withdrawls (successful withdrew order ID, failed
withdrew order ID)
