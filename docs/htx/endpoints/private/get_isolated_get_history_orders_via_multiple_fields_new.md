# GET [Isolated] Get History Orders via Multiple Fields(New)

**Source:**
[[Isolated] Get History Orders via Multiple Fields(New)](https://www.htx.com/en-us/opend/newApiPages/?id=8cb85cf7-77b5-11ed-9966-0242ac110003)
...
### /linear-swap-api/v3/swap_hisorders_exact (\[Isolated\] Get History Orders via Multiple Fields(New))
