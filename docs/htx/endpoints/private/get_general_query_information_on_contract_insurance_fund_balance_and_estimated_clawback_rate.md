...
**Source:**
[[General] Query information on contract insurance fund balance and estimated clawback rate](https://www.htx.com/en-us/opend/newApiPages/?id=8cb7feba-77b5-11ed-9966-0242ac110003)
...
### /linear-swap-api/v1/swap_risk_info (\[General\] Query information on contract insurance fund balance and estimated clawback rate)
...
| ------------- | --------- | -------- | ------------------------------ | ---------------------------------------------------- | ------------- |
| contract_code | string    | false    | contract code                  | swap: "BTC-USDT"... , future: "BTC-USDT-FUTURES" ... |               |
