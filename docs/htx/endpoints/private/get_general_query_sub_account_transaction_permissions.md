...
**Source:**
[[General] Query sub-account transaction permissions](https://www.htx.com/en-us/opend/newApiPages/?id=8cb89359-77b5-11ed-9966-18d119ebd6b)
...
### /linear-swap-api/v1/swap_sub_auth_list (\[General\] Query sub-account transaction permissions)
