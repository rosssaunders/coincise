# GET Query account financial records(New)

**Source:**
[Query account financial records(New)](https://www.htx.com/en-us/opend/newApiPages/?id=5d518f5f-77b6-11ed-9966-0242ac110003)
...
### /swap-api/v3/swap_financial_record (Query account financial records(New))
...
| start_time | long      | false    | Query start time, query by data creation time                                                                                                                                            | Value range \[((end-time) – 48h), (end-time)\], maximum query window size is 48 hours, query window shift should be within past 90 days.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | (now) – 48h   |
