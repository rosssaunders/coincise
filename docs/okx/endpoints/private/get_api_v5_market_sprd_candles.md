...
Source:
[https://www.okx.com/docs-v5/en/#spread-trading-rest-api-get-candlesticks](https://www.okx.com/docs-v5/en/#spread-trading-rest-api-get-candlesticks)
...
newer than the requested ts. The latest data will be returned when using before
individually | | limit | String | No | Number of results per request. The
maximum is 300. The default is 100. |
