...
Source:
[https://www.okx.com/docs-v5/en/#funding-account-rest-api-get-deposit-order-history](https://www.okx.com/docs-v5/en/#funding-account-rest-api-get-deposit-order-history)
...
`pending`  
`canceled`  
`inqueue` | | cTime | String | Creation time of the transaction, Unix timestamp
format in milliseconds, e.g. `1597026383085` | | uTime | String | Update time of
the transaction, Unix timestamp format in milliseconds, e.g. `1597026383085` |
