...
Source:
[https://www.okx.com/docs-v5/en/#order-book-trading-trade-post-place-easy-convert](https://www.okx.com/docs-v5/en/#order-book-trading-trade-post-place-easy-convert)
...
`running`: Running  
`filled`: Filled  
`failed`: Failed | | fromCcy | String | Type of small payment currency convert
from | | toCcy | String | Type of mainstream currency convert to | | fillFromSz
| String | Filled amount of small payment currency convert from | | fillToSz |
String | Filled amount of mainstream currency convert to | | uTime | String |
