...
Source:
[https://www.okx.com/docs-v5/en/#order-book-trading-signal-bot-trading-get-signal-bot-order-details](https://www.okx.com/docs-v5/en/#order-book-trading-signal-bot-trading-get-signal-bot-order-details)
...
`0`: None  
`1`: Manual stop | | totalPnl | String | Total P&L | | totalPnlRatio | String |
Total P&L ratio | | totalEq | String | Total equity of strategy account | |
floatPnl | String | Float P&L | | realizedPnl | String | Realized P&L | |
frozenBal | String | Frozen balance | | availBal | String | Avail balance | |
