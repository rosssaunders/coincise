...
Source: [https://www.okx.com/docs-v5/en/#block-trading-rest-api-get-rfqs](https://www.okx.com/docs-v5/en/#block-trading-rest-api-get-rfqs)
...
    1. if any allocated account is pending execution, then pending\_fill  
    2. otherwise,  
