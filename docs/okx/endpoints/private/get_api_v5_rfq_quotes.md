...
Source:
[https://www.okx.com/docs-v5/en/#block-trading-rest-api-get-quotes](https://www.okx.com/docs-v5/en/#block-trading-rest-api-get-quotes)
...
contracts or spot. | | \>> px | String | The price of the leg. | | \>> side |
String | The direction of the leg. Valid values can be buy or sell. | | \>>
