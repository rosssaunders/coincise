...
Source:
[https://www.okx.com/docs-v5/en/#trading-statistics-rest-api-get-contract-taker-volume](https://www.okx.com/docs-v5/en/#trading-statistics-rest-api-get-contract-taker-volume)
...
\[`6Hutc/12Hutc/1Dutc/2Dutc/3Dutc/5Dutc/1Wutc/1Mutc/3Mutc`\] | | unit | string |
No | The unit of buy/sell volume, the default is `1`  
`0`: Crypto  
`1`: Contracts  
`2`: U | | end | string | No | return records earlier than the requested `ts` |
| begin | string | No | return records newer than the requested `ts` | | limit |
