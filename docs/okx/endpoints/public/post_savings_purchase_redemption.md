...
Source:
[https://www.okx.com/docs-v5/en/#financial-product-simple-earn-flexible-post-savings-purchase-redemption](https://www.okx.com/docs-v5/en/#financial-product-simple-earn-flexible-post-savings-purchase-redemption)
...
`redempt`: redeem saving shares | | rate | String | Conditional | Annual
purchase rate, e.g. `0.1` represents `10%`  
