...
Source:
[https://www.okx.com/docs-v5/en/#order-book-trading-copy-trading-post-first-copy-settings](https://www.okx.com/docs-v5/en/#order-book-trading-copy-trading-post-first-copy-settings)
...
Conditional | Copy amount per order in USDT. | | copyRatio | String |
Conditional | Copy ratio per order. | | tpRatio | String | No | Take profit per
order. 0.1 represents 10% | | slRatio | String | No | Stop loss per order. 0.1
represents 10% | | slTotalAmt | String | No | Total stop loss in USDT for
trader.  
