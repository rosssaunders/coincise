...
Source:
[https://www.okx.com/docs-v5/en/#funding-account-rest-api-get-withdrawal-payment-methods](https://www.okx.com/docs-v5/en/#funding-account-rest-api-get-withdrawal-payment-methods)
...
minAmt | String | The minimum amount allowed per transaction | | \> maxAmt |
String | The maximum amount allowed per transaction | | \> lifetimeLimit |
