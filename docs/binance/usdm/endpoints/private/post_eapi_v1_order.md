...
- The Websocket base url for **testnet** is:
  - High Performance Market Data url
    path:"wss://fstream.binancefuture.com/public/"
  - Market Data url path: "wss://fstream.binancefuture.com/market/"
  - Private Data url path: "wss://fstream.binancefuture.com/private/"
- After generating an API key on the testnet, users can use this API key
  directly for testnet options trading.
...
- Specific error codes and messages defined in
  [Error Codes](/docs/derivatives/options-demo-trading/general-info#error-codes).
...
> Source:
> [https://developers.binance.com/docs/derivatives/options-demo-trading/general-info](https://developers.binance.com/docs/derivatives/options-demo-trading/general-info)
