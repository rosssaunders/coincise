...
- The REST base url for **testnet** is
...
- **Exception integrated here**: When a request **reduces exposure**
  ...
  reduction.
  - Covered endpoints: `POST /fapi/v1/order`、`POST /fapi/v1/batchOrders` (when
...
**SDK:** To get the provided SDK for Binance Futures Connector, please visit
[https://github.com/binance/binance-connector-python](https://github.com/binance/binance-connector-python),
...
To get the provided SDK for Binance Futures, please visit
[https://github.com/binance/binance-connector-java](https://github.com/binance/binance-connector-java),
or use the command below:
...
| 1008 | Request Throttled​                             | \- Server is currently overloaded with other requests. Please try again in a few minutes. - Request throttled by system-level protection. Reduce-only/close-position orders are exempt. Please try again.                                                                                            |
...
| 2011 | CANCEL_REJECTED​                               | \- CANCEL_REJECTED - Cancel request failure as open order not found in the orderbook: "Unknown order sent".                                                                                                                                                                                          |
...
| 2022 | REDUCE_ONLY_REJECT​                            | \- ReduceOnly Order is rejected. - This indicates the new reduce-only order conflicts with existing open orders; cancel the existing order and resubmit the reduce-only order.                                                                                                                       |
