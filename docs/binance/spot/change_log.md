...
#### User Data Streams[​](/docs/binance-spot-api-docs#user-data-streams "Direct link to User Data Streams")
...
### 2023-12-08[​](/docs/binance-spot-api-docs#2023-12-08 "Direct link to 2023-12-08")
...
depth | Limit 1-100 | 2 | 5 Limit 101-500 | 10 | 25 Limit 501-1000 | 20 | 50
Limit 1001-5000 | 100 | 250 |

---

### 2023-10-03[​](/docs/binance-spot-api-docs#2023-10-03 "Direct link to 2023-10-03")
...
`ticker.24hr` - **With `symbol`** or **With `symbols` using 1-20 symbols** | 1 |
2 | | `GET /api/v3/ticker/24hr`  
`ticker.24hr` - **With `symbols using 21-100 symbols`** | 20 | 40 | |
`GET /api/v3/ticker/24hr`  
`ticker.24hr` - **Without `symbol` or `symbols using 101 or more symbols`** | 40
| 80 | | `GET /api/v3/avgPrice`  
...
### 2023-07-11[​](/docs/binance-spot-api-docs#2023-07-11 "Direct link to 2023-07-11")
...
permissions for. | This symbol is restricted for this account. Placing an order
when symbol is not TRADING. | Unsupported order combination. | This order type
is not possible in this trading phase. Placing an order with timeinForce=IOC or
FOK on a trading phase that does not support it. | Limit orders require GTC for
this phase. |
