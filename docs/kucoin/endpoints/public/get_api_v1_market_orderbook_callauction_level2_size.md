# GET /api/v1/market/orderbook/callauction/level2\_{size}

**Source:**
[/api/v1/market/orderbook/callauction/level2\_{size}](https://www.kucoin.com/docs/rest//api/v1/market/orderbook/callauction/level2_{size})
