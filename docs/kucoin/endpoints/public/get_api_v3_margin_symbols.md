...
**Source:**
[/api/v3/margin/symbols](https://www.kucoin.com/docs/rest//api/v3/margin/symbols)
...
to quote currency. | | data.items[].feeCurrency | required | string | The
currency of charged fees. | | data.items[].priceLimitRate | required | string |
Threshold for price protection | | data.items[].minFunds | required | string |
