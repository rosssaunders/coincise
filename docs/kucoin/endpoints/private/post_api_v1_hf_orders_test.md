...
**Source:** [/api/v1/hf/orders/test](https://www.kucoin.com/docs/rest//api/v1/hf/orders/test)
...
| clientTimestamp | optional | integer | Equal to KC-API-TIMESTAMP, Need to be defined if allowMaxTimeWindow is specified. |
