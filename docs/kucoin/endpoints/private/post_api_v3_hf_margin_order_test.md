...
**Source:**
[/api/v3/hf/margin/order/test](https://www.kucoin.com/docs/rest//api/v3/hf/margin/order/test)
...
| data.loanApplyId | required | string | Borrowed amount. The field is returned only after placing the order under the mode of Auto-Borrow.                            |
| data.borrowSize  | required | number | ID of the borrowing response. The field is returned only after placing the order under the mode of Auto-Borrow.               |
