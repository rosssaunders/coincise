...
**Source:**
[/api/v1/positions](https://www.kucoin.com/docs/rest//api/v1/positions)
...
|                          |
| data[].riskLimit         | optional | number  | Risk limit **Only applicable to Isolated Margin**                                                                                                       |
|                          |
...
|                          |
| data[].posCrossMargin    | optional | number  | Additional margin calls (automatic, manual, adjusted risk limits) **Only applicable to Isolated Margin**                                                |
|                          |
