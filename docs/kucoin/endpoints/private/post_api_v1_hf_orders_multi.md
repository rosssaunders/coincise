...
**Source:**
[/api/v1/hf/orders/multi](https://www.kucoin.com/docs/rest//api/v1/hf/orders/multi)
...
of two: size or funds | | orderList[].clientTimestamp | optional | integer |
Equal to KC-API-TIMESTAMP. Needs to be defined if allowMaxTimeWindow is
specified. | | orderList[].allowMaxTimeWindow | optional | integer | Order
