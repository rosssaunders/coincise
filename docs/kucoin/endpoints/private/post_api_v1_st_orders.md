...
**Source:** [/api/v1/st-orders](https://www.kucoin.com/docs/rest//api/v1/st-orders)
...
| stopPriceType | optional | string | Either 'TP', 'IP' or 'MP' |
...
| triggerStopUpPrice | optional | string | Take profit price |
| triggerStopDownPrice | optional | string | Stop loss price |
