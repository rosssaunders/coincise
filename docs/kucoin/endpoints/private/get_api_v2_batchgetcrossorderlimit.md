...
**Source:**
[/api/v2/batchGetCrossOrderLimit](https://www.kucoin.com/docs/rest//api/v2/batchGetCrossOrderLimit)
...
Defaults to 10,000 in margin currency for max position calculation. For
USDT/USDC, it's 10,000 USD; for others, it's 10,000 divided by the token's USDT
price. | | leverage | optional | integer | Calculates the max position size at
the specified leverage. Defaults to the symbol’s max cross leverage. |
