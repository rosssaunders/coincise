...
**Source:**
[/api/v1/hf/orders/sync](https://www.kucoin.com/docs/rest//api/v1/hf/orders/sync)
...
required | string | Specify if the order is a 'limit' order or 'market' order.
...
| clientTimestamp | optional | integer | Equal to KC-API-TIMESTAMP. Needs to be
