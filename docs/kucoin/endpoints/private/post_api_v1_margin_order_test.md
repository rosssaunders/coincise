...
**Source:** [/api/v1/margin/order/test](https://www.kucoin.com/docs/rest//api/v1/margin/order/test)
...
| stp | optional | string | [Self Trade Prevention](https://www.kucoin.com/docs-new/api-5176570) is divided into four strategies: CN, CO, CB , and DC |
...
| hidden | optional | boolean | Hidden or not (not shown in order book) |
| iceberg | optional | boolean | Whether or not only visible portions of orders are shown in iceberg orders |
...
| marginModel | optional | string | The type of trading, including cross (cross mode) and isolated (isolated mode). It is set at cross by default. |
