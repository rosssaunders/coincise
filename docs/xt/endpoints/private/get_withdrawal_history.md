...
| status | string | false | N/A | Withdrawal status (see [depositWithdrawStatus](/docs/spot/Access Description/PublicModule#depositwithdraw-status)) | SUBMIT, REVIEW, AUDITED, AUDITED\_AGAIN, PENDING, SUCCESS, FAIL, CANCEL |
