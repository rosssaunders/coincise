...
```bash
xxxxxxxxxx1curl --request GET      --url 'https://region-api.upbit.com/v1/candles/weeks?count=1'      --header 'accept: application/json'
```
...
```json
[2  {3    "market": "SGD-BTC", "candle_date_time_utc": "2025-07-28T00:00:00", "opening_price": 152702, "high_price": 153526, "low_price": 151500, "trade_price": 152114, "timestamp": 1753909903998, "candle_acc_trade_price": 39991.1838817, "candle_acc_trade_volume": 0.26276451, "first_day_of_period": "2025-07-28"13  }14]
```
