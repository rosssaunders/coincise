...
Retrieves the list of candles per month.
...
```bash
xxxxxxxxxx1curl --request GET      --url 'https://region-api.upbit.com/v1/candles/months?count=1'      --header 'accept: application/json'
```
...
```json
[2  {3    "market": "SGD-BTC", "candle_date_time_utc": "2025-07-01T00:00:00", "opening_price": 138284, "high_price": 157745, "low_price": 134053, "trade_price": 152114, "timestamp": 1753909903998, "candle_acc_trade_price": 267280.01931441, "candle_acc_trade_volume": 1.81998461, "first_day_of_period": "2025-07-01"13  }14]
```
