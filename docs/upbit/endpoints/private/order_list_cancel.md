...
```bash
xxxxxxxxxx1curl --request DELETE \2    --url 'https://{region}-api.upbit.com/v1/orders/uuids?uuids[]=bbbb8e07-1689-4769-af3e-a117016623f8&uuids[]=4312ba49-5f1a-4a01-9f3b-2d2bce17267e&uuids[]=bdb49a54-de36-4eb4-a963-9c8d4337a9da' \3    --header 'Authorization: Bearer {JWT_TOKEN}' \4    --header 'accept: application/json'5​
```
