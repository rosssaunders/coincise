...
```bash
xxxxxxxxxx1curl --request GET \2    --url 'https://{region}-api.upbit.com/v1/withdraw?currency=BTC' \3    --header 'Authorization: Bearer {JWT_TOKEN}' \4    --header 'Accept: application/json'5​
```
