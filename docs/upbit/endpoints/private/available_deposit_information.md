...
```bash
xxxxxxxxxx1curl --request GET   --url 'https://{region}-api.upbit.com/v1/deposits/chance/coin?currency=BTC&net_type=BTC'   --header 'Authorization: Bearer {JWT_TOKEN}'   --header 'Accept: application/json'5​
```
