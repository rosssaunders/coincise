...
```bash
curl --request DELETE     --url 'https://{region}-api.upbit.com/v1/order?uuid=cdd92199-2897-4e14-9448-f923320408ad'     --header 'Authorization: Bearer {JWT_TOKEN}'     --header 'Accept: application/json'5​
```
