...
pair | | »`type` | String | Order type. limit - limit order | | »`account` |
String | Account type. spot - spot account; margin - margin account | | »`side`
| String | Order side | | »`amount` | String | Trade amount | | »`price` |
