...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#gate-io-futures-websocket-v4) Gate.io Futures WebSocket v4

Gate.io provides a simple and robust Websocket API to integrate gate.io BTC/USDT futures contract
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#server-url) Server URL

We provide BTC/USDT futures contract trade server urls, you can choose one of them according to your
condition.

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#btc-contract) BTC Contract
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#usdt-contract) USDT Contract
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#changelog) Changelog
...
- Add new order book channel `futures.order_book_update` to push order book change with user
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#api-overview) API Overview

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#method) Method
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request) Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#response) Response
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#error) Error
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#authentication) Authentication
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#system-api) System API

**Provides system status check, such as ping-pong.**

## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#ping-and-pong) Ping and Pong

**Check Server/Client connectivity.**

**gate.io futures contract use the protocol layer ping/pong message.The server will initiate a ping**
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-2) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#tickers-api) Tickers API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#tickers-subscription) Tickers subscription

**Subscribe futures contract ticker.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-3) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#tickers-notification) Tickers notification

**Notify subscribed contract ticker.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify) Notify
...
| `funding_rate_indicative` | String | Indicative Funding rate in next period. (deprecated. use funding\_rate) |
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription) Cancel subscription

**Unsubscribe contract ticker.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-4) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#trades-api) Trades API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#trades-subscription) Trades subscription

**Subscribe trades update notification.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-5) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#trades-notification) Trades notification

**Notify latest trades update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-2) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-2) Cancel subscription

**Unsubscribe trades update notification.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-6) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-book-api) Order Book API
...
`["BTC_USDT", "100ms", "100"]` pushes the first 10 levels' update in BTC\_USDT order book every 1s
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#legacy-order-book-subscription) Legacy order book subscription

**Subscribe order\_book.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-7) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#legacy-order-book-notification) Legacy order book notification

**Notify contract order book update information**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-3) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#legacy-order-book-unsubscription) Legacy order book unsubscription

**Unsubscribe specified contract order book.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-8) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#best-ask-bid-subscription) Best ask/bid subscription

**Subscribe book\_ticker.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-9) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#best-ask-bid-notification) Best ask/bid notification
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-4) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#best-ask-bid-unsubscription) Best ask/bid unsubscription

**Unsubscribe specified contract order book.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-10) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-book-update-subscription) Order book update subscription

**Subscribe order\_book\_update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-11) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-book-update-notification) Order book update notification

**Notify contract order book update**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-5) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-book-update-unsubscription) Order book update unsubscription

**Unsubscribe specified contract order book.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-12) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#candlesticks-api) Candlesticks API

**Provides a way to access charting candlestick info.**

## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#candlesticks-subscription) Candlesticks subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-13) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#candlesticks-notification) Candlesticks notification

**Notify kline information of subscribed contract.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-6) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-3) Cancel subscription

**Unsubscribe specified contract kline information.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-14) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#contract-stats-api) Contract Stats API

**The contract\_stats channel allows you to obtain contract statistics.**

## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#contract-stats-subscription) Contract Stats subscription

**Subscribe futures contract stats.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-15) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#contract-stats-notification) Contract Stats notification

**Notify subscribed contract stats.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-7) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-4) Cancel subscription

**Unsubscribe contract stats.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-16) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#orders-api) Orders API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#orders-subscription) Orders subscription

If you want to subscribe to order updates in all contracts, use `!all` in contract list.

**Subscribe user orders update**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-17) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#orders-notification) Orders notification

**Notify user orders information when an order is put, updated or finished.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-8) Notify
...
| `finish_as` | String | How the order was finished.<br>\- filled: all filled<br>\- cancelled: manually cancelled<br>\- liquidated: cancelled because of liquidation<br>\- ioc: time in force is IOC, finish immediately<br>\- auto\_deleveraged: finished by ADL<br>\- reduce\_only: cancelled because of increasing position while reduce-only set- position\_closed: cancelled because of position close<br>\- stp: cancelled because self trade prevention |
...
| `tif` | String | Time in force <br>\- gtc: GoodTillCancelled <br>\- ioc: ImmediateOrCancelled, taker only<br>\- poc: PendingOrCancelled, makes a post-only order that always enjoys a maker fee<br>\- fok: FillOrKill, fill either completely or none<br>Only ioc and fok are supported when type=market |
...
| `stp_id` | String | Orders between users in the same stp\_id group are not allowed to be self-traded<br>1\. If the stp\_id of two orders being matched is non-zero and equal, they will not be executed. Instead, the corresponding strategy will be executed based on the stp\_act of the taker.<br>2\. stp\_id returns 0 by default for orders that have not been set for STP group |
| `stp_act` | String | Self-Trading Prevention Action. Users can use this field to set self-trade prevetion strategies<br>1\. After users join the STP Group, he can pass stp\_act to limit the user's self-trade prevetion strategy. If stp\_act is not passed, the default is cn strategy。<br>2\. When the user does not join the STP group, an error will be returned when passing the stp\_act parameter。<br>3\. If the user did not use 'stp\_act' when placing the order, 'stp\_act' will return '-'<br>\- cn: Cancel newest, Cancel new orders and keep old ones<br>\- co: Cancel oldest, Cancel old orders and keep new ones<br>\- cb: Cancel both, Both old and new orders will be cancelled |
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-5) Cancel subscription

**Unsubscribe user orders update notification, for all contract.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-18) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#user-trades-api) User trades API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#user-trades-subscription) User trades subscription

If you want to subscribe to user trade updates in all contracts, use `!all` in contract list.

**Subscribe for user trades update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-19) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#user-trades-notification) User trades notification

**Notify user trades update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-9) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-6) Cancel subscription

**Unsubscribe user trades update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-20) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#liquidates-api) Liquidates API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#liquidates-subscription) Liquidates subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-21) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#liquidates-notification) Liquidates notification

**Notify liquidates update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-10) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-7) Cancel subscription

**Unsubscribe liquidates update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-22) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-deleverages-api) Auto\_deleverages API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-deleverages-subscription) Auto\_deleverages subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-23) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-deleverages-notification) Auto\_deleverages notification

**Notify auto\_deleverages update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-11) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-8) Cancel subscription

**Unsubscribe auto\_deleverages update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-24) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#position-closes-api) Position\_closes API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#position-closes-subscription) Position\_closes subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-25) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#position-closes-notification) Position\_closes notification

**Notify position\_closes update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-12) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-9) Cancel subscription

**Unsubscribe position\_closes update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-26) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#balances-api) Balances API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#balances-subscription) Balances subscription

**Subscribe for user balances update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-27) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#balances-notification) balances notification

**Notify balances update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-13) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-10) Cancel subscription
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#reduce-risk-limits-api) Reduce\_risk\_limits API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#reduce-risk-limits-subscription) Reduce\_risk\_limits subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-28) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#reduce-risk-limits-notification) Reduce\_risk\_limits notification

**Notify reduce risk limits update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-14) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-11) Cancel subscription

**Unsubscribe reduce risk limits update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-29) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#positions-api) Positions API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#positions-subscription) Positions subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-30) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#positions-notification) Positions notification

**Notify positions update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-15) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-12) Cancel subscription

**Unsubscribe positions update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-31) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-orders-api) Auto orders API
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-orders-subscription) Auto orders subscription
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-32) Request
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#auto-orders-notification) Auto orders notification

**Notify auto orders update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#notify-16) Notify
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-subscription-13) Cancel subscription

**Unsubscribe auto orders update.**

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#request-33) Request
...
# [\#](https://www.gate.io/docs/developers/futures/ws/en/\#futures-account-trade) Futures Account Trade

## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#websocket-api) Websocket API

WebSocket API allows placing , canceling , amending , querying orders through a WebSocket connection.

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#websocket-api-client-api-request) Websocket API Client Api Request
...
| `id` | Integer | No | Optional request id which will be sent back by the server to help you identify which<br>request the server responds to |
...
| » `req_id` | String | Yes | Unique identifier of the message Provided by client.It will be returned in response message for<br>identifying the corresponding request. |
| » `timestamp` | String | Yes | Signature time in seconds |
| » `api_key` | String | Yes | Gate APIv4 user key string |
| » `signature` | String | Yes | Authentication signature generated using GateAPIv4 secret and request information,<br>See\[Websocket API Authentication\](#Websocket API Authentication) section for details |
...
apiv4 [/futures/{settle}/orders(opens new window)](https://www.gate.io/docs/developers/apiv4/en/#create-a-futures-order).
You can place a limit order for BTC\_USDT with example.
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#websocket-api-server-response) Websocket API Server Response
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#error-2) Error
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#login) Login

WARNING

Note: the GateAPIv4 key pair you used MUST have future Corresponding permissions(eg: order-place channel must have future write permissions),
and your outbound IP address must be in the key's IP whitelist if its whitelist is enabled.

### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#login-request) Login Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#login-notification) Login Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-place) Order Place
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-place-request) Order Place Request
...
#### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#detail) Detail
...
After the user joins the `STP Group`, they can use `stp_act` to limit their self-trade prevention strategy. If `stp_act` is not provided, the default strategy is `cn`.
When the user is not part of the `STP group`, passing the parameter will return an error with `stp_act`.
If the user does not use `stp_act` when placing an order, `stp_act` will return `-`.
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#ack-notification) Ack Notification
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-place-notification) Order Place Notification
...
| --- | --- | --- |
| `request_id` | String | Unique identifier of the message |
| `ack` | Bool | The return of the "ack" message represents the WebSocket confirmation message(Currently exists in the order-place api).<br>If "ack" is false(this field will not be returned), it means that the message is a response message, and you can determine if the request was successful <br>by checking "data.errs". |
| `header` | Map | Response meta info |
| » `response_time` | String | Response send time in mill |
| » `channel` | String | Request channel |
| » `event` | String | Request event |
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-batch-place) Order Batch Place
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-batch-place-request) Order Batch Place Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-batch-place-ack-notification) Order Batch Place Ack Notification
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-batch-place-notification) Order Batch Place Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-cancel) Order Cancel
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-cancel-request) Order Cancel Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-status-notification) Order Status Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-all-open-orders-matched) Cancel all open orders matched
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-all-open-orders-matched-request) Cancel all open orders matched Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#cancel-all-open-orders-matched-notification) Cancel all open orders matched Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-amend) Order Amend
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-amend-request) Order Amend Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-amend-notification) Order Amend Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-list) Order List
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-list-request) Order List Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-list-notification) Order List Notification
...
## [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-status) Order Status
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-status-request) Order Status Request
...
### [\#](https://www.gate.io/docs/developers/futures/ws/en/\#order-cancel-notification) Order Cancel Notification
