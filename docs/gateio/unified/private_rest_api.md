...
_Get unified account information._
...
_Query about the maximum borrowing for the unified account._
...
_Query about the maximum transferable for the unified account._
...
_Batch query unified account can be borrowed up to a maximum._
...
For repayment, the option to repay the available by setting the parameter
`repaid_all=true`
...
_Unified account loan and repayment response results._
...
_Set mode of the unified account._
...
_Query mode of the unified account._
...
_Estimate the current hourly lending rates, categorized by currency._
...
_List currency discount tiers._
...
_Portfolio margin calculator._
...
price, and order of BTC and ETH perpetual contracts, options, and spot markets.
Market orders are not included.
...
| position + positive delta orders, orders.                                                                    |
...
_Minimum currency leverage that can be set._
...
_Get the leverage multiple of the user currency._
...
_Set the loan currency leverage._
...
_List of loan currencies supported by unified account._
...
_get historical lending rates._
...
_Return of unified account collateral mode settings._
