...
| u         | integer | Update ID, is always in sequence<ul><li>For contract, corresponds to <code>u</code> in the 500-level <a href="https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook" target="_blank" rel="noopener noreferrer">WebSocket orderbook stream</a></li><li>For spot, corresponds to <code>u</code> in the 200-level <a href="https://bybit-exchange.github.io/docs/v5/websocket/public/orderbook" target="_blank" rel="noopener noreferrer">WebSocket orderbook stream</a></li></ul> |
