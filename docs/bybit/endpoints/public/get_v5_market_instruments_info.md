...
- This is to identify if the symbol supports margin trading under different
  account modes
...
priceFilter | Object | Price attributes | | \>> tickSize | string | The step to
increase/reduce order price | | \> riskParameters | Object | Risk parameters for
limit order price, refer to
...
](/docs/v5/market/premium-index-kline)[

Next

Get Orderbook

](/docs/v5/market/orderbook)
