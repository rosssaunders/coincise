...
- You can query filled, cancelled, and rejected orders to the most recent 500
  orders for spot, linear, inverse and option categories
...
- `1`: Query a maximum of recent 500 closed status records are kept under each
