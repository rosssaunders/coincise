...
**Source:**
[Adjust Collateral Amount](https://bybit-exchange.github.io/docs/v5/crypto-loan/adjust-collateral)
...
You can increase or reduce your collateral amount. When you reduce, please obey
the
[max. allowed reduction amount](https://bybit-exchange.github.io/docs/v5/crypto-loan/reduce-max-collateral-amt).

> Permission: "Spot trade"

info

- The adjusted collateral amount will be returned to or deducted from the
  Funding wallet.
...
](/docs/v5/crypto-loan/reduce-max-collateral-amt)[

Next

Get Loan LTV Adjustment History

](/docs/v5/crypto-loan/ltv-adjust-history)
