...
**Source:**
[Set Leverage](https://bybit-exchange.github.io/docs/v5/spot-margin-uta/set-leverage)
...
the quiz on web / app.  
The updated leverage must be less than or equal to the maximum leverage of the
currency
...
](/docs/v5/spot-margin-uta/status)
