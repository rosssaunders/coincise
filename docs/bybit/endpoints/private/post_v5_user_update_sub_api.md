...
**Source:**
[Modify Sub API Key](https://bybit-exchange.github.io/docs/v5/user/modify-sub-apikey)
...
Modify the settings of sub api key. Use the sub account api key pending to be
modified to call the endpoint or use master account api key to manage its sub
account api key.
...
| ips | false | string | Set the IP bind. example:
`"192.168.0.1,192.168.0.2"`**note:**
...
_Note: fund custodial account is not supported_ | | \> Options | false | array |
USDC Contract. `["OptionsTrade"]` | | \> Derivatives | false | array | This
param is **deprecated** because system will automatically add this permission
according to your account is UTA or Classic | | \> Exchange | false | array |
Convert. `["ExchangeHistory"]` | | \> Earn | false | array | Earn product.
`["Earn"]` | | \> CopyTrading | false | array | Copytrade. `["CopyTrading"]` |
