...
error codes. The exact release time will be on October 16, please prepare in
advance.

- Old error code 109414 has been updated to new error code 109400, meaning:
  parameter invalid
- Old error code 80014 has been updated to new error code 109400, meaning:
  parameter invalid
- Old error code 80001 has been updated to new error code 109400, meaning:
  parameter invalid
- Old error code 40029 has been updated to new error code 109403, meaning: risk
  forbidden
- Old error code 80019 has been updated to new error code 109423, meaning: The
  order is being processed. Please use the allOrders interface to retrieve the
  order details later.
- Old error code 80012 has been updated to new error code 109500, meaning:
  system error
- Old error code 80016 has been updated to new error code 109421, meaning: order
  not exist
- Old error code 80018 has been updated to new error code 109422, meaning:
  APIAccountErrorOrderStatusIllegal
- Old error code 80020 has been updated to new error code 109403, meaning: risk
  forbidden
- Old error code 80017 has been updated to new error code 109422, meaning:
  position not exist
- Old error code 80019 has been updated to new error code 109424, meaning: twap
  change marginType failed
- Old error code 100409 has been updated to new error code 109429, meaning:
  APIRateLimit
- Old error code 100410 has been updated to new error code 109429, meaning:
  APIRateLimit

2025-10-09

- BingX Fully Releases Spot Account
  Function:https://bingx.com/en/support/articles/13672873913359
...
- USDT-M Perp Futures:Added Trading Rules API
