...
| --- | --- | --- | --- | --- |
| currency | true | string | BTC ETH USDC USDT any grouped | The currency symbol or "any" for all or '"grouped"' for all grouped by currency |
| kind | true | string | future option any | Instrument kind, "future" or "option" or "any" |
...
| result[].currency | string | Currency name or "any" if don't care or "grouped" if grouped by currencies |
| result[].kind | string | Instrument kind: "future", "option" or "any" for all |