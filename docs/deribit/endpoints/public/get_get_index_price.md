...
| result.estimated_delivery_price | number | Estimated delivery price for the market. For more details, see Documentation > General > Expiration Price |
| result.index_price | number | Value of requested index |