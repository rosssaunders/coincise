...
quote | |   ›  bids | array of _object_ | | |   ›    ›  amount | number | This
...
string | Direction: `buy`, or `sell` | |   ›    ›  instrument_name | string |
...
characters) | |   ›  legs | array of _object_ | | |   ›    ›  direction | string
| Direction: `buy`, or `sell` | |   ›    ›  instrument_name | string | Unique
instrument identifier | |   ›    ›  ratio | integer | Ratio of amount between
legs | |   ›  makers | array of string | List of targeted Block RFQ makers | |
...
  ›  trade_allocations | array of _object_ | List of allocations for Block RFQ
...
| |   ›    ›  client_info | _object_ | Client allocation info for brokers. | |
...
obstructed. | |   ›  trade_trigger | _object_ | Contains information about the
trade trigger state | |   ›    ›  cancel_reason | string | Reason for
...
`"untriggered"` or `"cancelled"` | |   ›  trades | array of _object_ | | |
