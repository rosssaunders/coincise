...
| --- | --- | --- | --- | --- |
| currency | false | string | BTC ETH USDC USDT EURR any |  |
| kind | false | string | future option spot future_combo option_combo | Kind filter on positions |
