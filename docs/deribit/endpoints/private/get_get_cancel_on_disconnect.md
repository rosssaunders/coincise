# GET /private/get\_cancel\_on\_disconnect
...
| result.enabled | boolean | Current configuration status |
| result.scope | string | Informs if Cancel on Disconnect was checked for the current connection or the account |