...
_object_ | | |   ›    ›    ›  amount | number | This value multiplied by the
...
expire (milliseconds since the UNIX epoch) | |   ›    ›  hedge | _object_ | | |
...
characters) | |   ›    ›  legs | array of _object_ | | |
  ›    ›    ›  direction | string | Direction: `buy`, or `sell` | |
  ›    ›    ›  instrument_name | string | Unique instrument identifier | |
...
Rating of the taker | |   ›    ›  trade_allocations | array of _object_ | List
...
| _object_ | Client allocation info for brokers. | |
  ›    ›    ›    ›  client_id | integer | ID of a client; available to broker.
...
obstructed. | |   ›    ›  trade_trigger | _object_ | Contains information about
the trade trigger state | |   ›    ›    ›  cancel_reason | string | Reason for
...
state: `"untriggered"` or `"cancelled"` | |   ›    ›  trades | array of _object_
| | |   ›    ›    ›  amount | number | Trade amount. For options, linear
futures, linear perpetuals and spots the amount is denominated in the underlying
base currency coin. The inverse perpetuals and inverse futures are denominated
in USD units. | |   ›    ›    ›  direction | string | Direction: `buy`, or
`sell` | |   ›    ›    ›  hedge_amount | number | Amount of the hedge leg. For
...
denominated in USD units. | |   ›    ›    ›  maker | string | Alias of the maker
(optional) | |   ›    ›    ›  price | number | Price in base currency | |
