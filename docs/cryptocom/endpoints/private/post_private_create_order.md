...
**Source:** [private/create-order](https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html#private-create-order)
...
| exec\_inst | array of string | N | `POST_ONLY`,`SMART_POST_ONLY`  
Remarks: `POST_ONLY` and `SMART_POST_ONLY` cannot be coexisted in exec\_inst |
