...
**Source:** [private/advanced/cancel-all-orders](https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html#private-advanced-cancel-all-orders)
...
| --- | --- | --- | --- |
| instrument\_name | string | N | e.g. BTCUSD. If not provided, the OTO/OTOCO orders of ALL instruments will be canceled |
