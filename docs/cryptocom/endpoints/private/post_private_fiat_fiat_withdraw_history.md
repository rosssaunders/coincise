...
**Source:** [private/fiat/fiat-withdraw-history](https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html#private-fiat-fiat-withdraw-history)
...
| page\_size | number | Y | Number of items per page |
| start\_time | string | N | Start time for filtering transactions , required if end\_time is provided |
| end\_time | string | N | End time for filtering transactions |
...
| transaction\_history\_list | object | Y | See below |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| transaction\_history\_list | transaction\_history\_list array | Y | List of withdrawal transactions |
| page | number | Y | Current page number |
| page\_size | number | Y | Number of items per page |

  
****transaction\_history\_list**** consists of:  
...
| created\_at | string | Y | Transaction creation timestamp |
| completed\_at | string | N | Transaction completion timestamp |
