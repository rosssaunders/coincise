...
const extractAuthentication = async (page, turndownService) => {
  ...
  await page.goto(
    `${BASE_URL}/binance-spot-api-docs/rest-api/request-security`,
    {
      waitUntil: "networkidle2",
      timeout: 30000
    }
...
const extractNetworkConnectivity = async (page, turndownService) => {
  ...
  await page.goto(
    `${BASE_URL}/binance-spot-api-docs/rest-api/general-api-information`,
    {
      waitUntil: "networkidle2",
      timeout: 30000
    }
...
const extractResponseFormats = async (page, turndownService) => {
  ...
  await page.goto(
    `${BASE_URL}/binance-spot-api-docs/rest-api/http-return-codes`,
    {
      waitUntil: "networkidle2",
      timeout: 30000
    }
