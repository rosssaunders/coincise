...
export const config = {
  ...
  baseGithubUrl: 'https://raw.githubusercontent.com/Kucoin/kucoin-universal-sdk/main',

  // URLs for the API specification JSON files to download
  apiSpecUrls: {
    rest: {
      spot: ['/spec/rest/api/openapi-spot-market.json', '/spec/rest/api/openapi-spot-order.json'],
      futures: [
    ...
    ws: {
      spot: ['/spec/ws/openapi-spot-public.json', '/spec/ws/openapi-spot-private.json'],
      futures: ['/spec/ws/openapi-futures-public.json', '/spec/ws/openapi-futures-private.json'],
      margin: ['/spec/ws/openapi-margin-public.json', '/spec/ws/openapi-margin-private.json'],
    },
  },
