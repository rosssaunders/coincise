...
const GITHUB_BASE = "https://raw.githubusercontent.com/Kucoin/kucoin-universal-sdk/main";
 ...
 */
const generateEndpointMarkdown = (method, endpointPath, operation, isPublic) => {
...
const processEndpoint = (endpoint) => {
  ...
  // Generate markdown
  const markdown = generateEndpointMarkdown(method, endpointPath, operation, isPublic);
