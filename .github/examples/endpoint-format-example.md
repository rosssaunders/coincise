...
This document provides examples of correct and incorrect endpoint documentation formatting based on the specification in `AGENTS.md` and `CLAUDE.md`.
...
- Order data is cached for 5 seconds. Recent updates may not be immediately visible.
